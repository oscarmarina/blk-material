...
import { sysColor, dark } from './blk-sys-color.js';

const { namespace } = sysColor;
...
const darkColorScheme = unsafeCSS(cssStyleRule(`[data-prefers-color-scheme="dark"]`, [colorScheme]));
